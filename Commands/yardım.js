...
• \`${prefix}Kayıtlarım\` Kullanıcı kayıt istatistiklerini atar.
• \`${prefix}topteyit \` Sunucu teyit sıralamasını atar.
• \`${prefix}nerede @Üye\` Kişinin hangi ses kanalında olduğunu gösterir.
